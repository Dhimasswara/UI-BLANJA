...
import { faLocation, faLocationArrow, faLocationDot, faPencil, faPencilAlt, faPencilSquare, faPerson, faUser } from '@fortawesome/free-solid-svg-icons'
                ...
                <div className="col-12 col-md-3  pt-md-5 pt-3 m-0 sticky-top __col-left">
                    <ul className="nav flex-md-column align-items-center align-items-md-start justify-content-center gap-3 gap-md-0">
                        ...
                        <li className="nav-item pt-md-5 pt-0" >
                            <Link className='decoration-none d-flex align-items-center' to={'/profile-customer/test'} onClick={() => setLink('link1')}>
                                <FontAwesomeIcon icon={faUser} className='bg-danger p-2 rounded-circle' style={{ height: '13px', width: '13px' }}></FontAwesomeIcon>
                                <span className='ps-2 d-md-block d-none'>My Account</span>
                            </Link>
                        </li>
                        <li className="nav-item pt-md-3 pt-0">
                            <Link className='decoration-none d-flex align-items-center' to={'/profile-customer/test2'} onClick={() => setLink('link2')}>
                                <FontAwesomeIcon icon={faLocationDot} className='bg-primary p-2 rounded-circle' style={{ height: '13px', width: '13px' }}></FontAwesomeIcon>
