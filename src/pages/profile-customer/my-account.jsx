      ...
      <div className="row">
        <div className="col-lg-8 col-12 p-4">
          ...
          <div class="mb-3 row pt-4 ">
            ...
            <div class="col-8 d-lg-grid d-none">
              <button className='btn btn-danger rounded-pill' style={{width: '120px'}}>Save</button>
            </div>
          </div>
        ...
        <div className="col-lg-4 col-12 border-md-start border-none p-4 d-flex flex-column align-items-center">
          <div className="img pb-4">
            <img src={profile} alt="" style={{ height: '90px', width: '90px', borderRadius: '100%' }} />
          </div>
          <button className='btn btn-outline-secondary rounded-pill'>Select Image</button>
