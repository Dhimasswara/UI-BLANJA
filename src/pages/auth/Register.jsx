                        ...
                        <div className="col-11 col-md-8">
                            ...
                            <div className="tab-content" id="pills-tabContent">
                                <div className="tab-pane fade show active" id="pills-Customer" role="tabpanel"
                                    ...
                                    <form className="pt-4 " >
                                        <FormAuth title={'Name'} type={'text'}></FormAuth>
                                        <FormAuth title={'Email'} type={'email'}></FormAuth>
                                        <FormAuth title={'Password'} type={'password'}></FormAuth>
                                        <button type="submit" className="button create-account mt-4">Register</button>
                                    </form>
                                </div>
                                <div className="tab-pane fade" id="pills-Seller" role="tabpanel" aria-labelledby="pills-Seller-tab" tabindex="0">
                                    <form className="pt-4">
                                        <FormAuth title={'Name'} type={'text'}></FormAuth>
                                        <FormAuth title={'Email'} type={'email'}></FormAuth>
                                        <FormAuth title={'Phone Number'} type={'number'}></FormAuth>
                                        <FormAuth title={'Store Name'} type={'text'}></FormAuth>
                                        <FormAuth title={'Password'} type={'password'}></FormAuth>
                                        <button type="submit" className="button create-account mt-4">Register</button>
                                    </form>
                                </div>
                            ...
                            <div>
                                <p className="mt-5 Register">Don't have a Blanja account? <Link className='text-decoration-none' to={'/login'}>Login</Link></p>
                            </div>
                        </div>
